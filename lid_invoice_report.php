...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header">Lid Invoices</h3>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
        ...
        <thead>
			...
			<th>Outgoing</th><th>Out-Date</th><th>Out Challan-No</th><th>Balance</th><th>Rejection</th><th>Edit</th>
			</tr></thead><tboby>
			<?php
